        ...
        <div>
            <div className={`justify-between ${compClass}`}>
                <div className="text-[32px] sm:text-[22px] leading-[35px] sm:leading-[25px]">
                    <div>{h1Text}</div>
                    <div className="font-normal whitespace-nowrap">{h2Text}</div>
                </div>

                {link ? 
                    <Link to={link} className={linkClass}>
                        <div className={`flex items-center group text-[14px] text-${textColor1}  cursor-pointer`}>
                            <div className="mb-[5px] uppercase whitespace-nowrap group-hover:underline decoration-double">{actionText}</div>
                            <div className={`w-6 h-6 ml-[7px] rounded-full border-[1px] border-${textColor1} border-solid group-hover:bg-${textColor1} flex items-center justify-center`}>
